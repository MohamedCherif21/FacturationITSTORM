 ...
 */
final class Version20240429133645 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE client_email_address (client_id INT NOT NULL, email_address_id INT NOT NULL, INDEX IDX_C7383D7A19EB6921 (client_id), INDEX IDX_C7383D7A59045DAA (email_address_id), PRIMARY KEY(client_id, email_address_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE client CHANGE email n°siret VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE client CHANGE n°siret email VARCHAR(255) NOT NULL');
    }
}
